      ...
      const handleCustomButtonClick = (ev) => {
        switch (ev.button_id) {
          ...
          case transcriptId:
            ...
            break;
          case techStackId:
            setAiView((v) => (v === techStackId ? null : techStackId));
            break;
        }
      };
            ...
            <div className="container">
              <div className="call">
                ...
                >
                  ...
                  <div
                    style={{
                      display: aiView === techStackId ? "" : "none",
                      height: "100%",
                    }}
                  >
                    <ProfileTabs />
          ...
          <>
            ...
            <div>
              ...
              >
                ...
                />
                <span>
                  <label htmlFor="wantBotToken">
                    Give bot a meeting token (needed if room is private)
                  </label>
                  <input
                    readOnly={isJoining}
                    type="checkbox"
